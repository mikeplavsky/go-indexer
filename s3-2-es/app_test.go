...
func TestParseTime(t *testing.T) {
	...
	cases := []struct {
		...
		{"s3://s3bucket/path/mage_20231123_122134.zip", "2023-11-23T12:21:34Z"},
		{"s3://s3bucket/path/mage.08.28.1998.zip", "1998-08-28T00:00:00Z"}, //legacy format: US digitd order, Europerian dots, akward
		{"s3://dmp-log-analysis/Quadra2901/UKTCEUCMIGPRDV1/UnifiedCalendarSync/MAgE_20150129_031000 (1).zip", "2015-01-29T03:10:00Z"},
		{"", ""},
	}
